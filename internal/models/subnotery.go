...
type Subnotery struct {
	...
	// ProfilePictureURL is the R2 object key for the community profile picture.
	// Admins can upload/change profile pictures via the settings panel.
	ProfilePictureURL string `json:"profile_picture_url" gorm:"type:text;default:''"`
